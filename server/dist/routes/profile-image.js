...
import { uploadProfileImage, removeProfileImage, updateProfileImage } from '../services/profile-image-service';
const router = Router();
...
router.post('/upload/:userId', authMiddleware, upload.single('image'), async (req, res) => {
    try {
