 ...
 */
export const createPaymentIntent = async (userId, amount, currency = 'usd') => {
    try {
 ...
 */
export const handleSuccessfulPayment = async (paymentIntentId, userId, amount) => {
    try {
 ...
 */
export const verifyWebhookSignature = async (payload, signature, endpointSecret) => {
    try {
        const stripeInstance = await stripePromise;
 ...
 */
export const getUserTransactionHistory = async (userId, limit = 20, offset = 0) => {
    try {
