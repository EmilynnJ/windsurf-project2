...
export async function acquireResource(channelName, uid) {
...
export async function startRecording(channelName, uid, resourceId, token) {
...
export async function stopRecording(channelName, uid, resourceId, sid) {
